  ...
  return (
    <div className="w-full h-screen bg-black flex justify-center items-center overflow-hidden m-0 p-0">
      ...
      <div className="w-[92%] sm:w-[84%] max-w-275 flex flex-col justify-center items-center gap-2 sm:gap-3 px-2 sm:px-0 -translate-y-6 sm:-translate-y-8">
        ...
        >
          <path
            d="M7.44537 169.394C34.9398 153.208 58.7266 132.901 85.2671 96.9693C103.894 71.7507 113.005 49.0765 113.503 31.008C113.751 17.609 107.299 7.4442 95.1406 7.4442C81.7411 7.4442 73.3043 17.609 68.0934 40.9417C62.3862 66.5846 58.1679 96.009 47.4979 190.361"
            stroke="white"
            strokeWidth="14.8883"
            strokeLinecap="round"
          />
          <path
            d="M48.5436 181.14C53.8077 134.866 74.7931 98.0536 101.344 98.0536C117.225 98.0536 127.318 110.709 124.452 128.823C122.839 139.493 119.924 151.9 118.259 164.059C116.233 179.443 122.02 191.354 139.944 191.354C165.309 191.354 180.505 163.918 188.743 135.037"
            stroke="white"
            strokeWidth="14.8883"
            strokeLinecap="round"
          />
          <path
            d="M267.002 112.836C262.137 101.641 251.797 94.0833 235.338 94.0833C208.042 94.0833 187.529 121.379 186.182 150.659C185.008 177.458 197.374 192.523 214.988 192.346C239.988 192.096 258.365 167.54 266.568 115.583C267.58 109.173 268.629 102.479 269.641 96.0685"
            stroke="white"
            strokeWidth="14.8883"
            strokeLinecap="round"
          />
          <path
            d="M269.641 96.0685C268.616 102.571 267.592 109.073 266.567 115.576C262.086 144.016 260.018 155.236 260.24 162.57C260.758 179.691 266.916 191.354 286.403 191.354C320.182 191.354 366.759 134.555 389.169 75.5678C395.646 58.5186 398.118 42.4121 398.118 31.1568C398.118 17.8113 393.9 7.56384 381.989 7.56384C370.327 7.56384 362.634 16.6197 355.686 30.9185C347.546 47.5023 341.525 71.4218 339.061 98.4605C332.858 166.307 346.753 191.354 379.794 191.354C419.857 191.354 464.4 135.54 487.143 75.6742C493.661 58.5186 496.133 42.4121 496.133 31.1568C496.133 17.8113 491.915 7.56384 480.004 7.56384C468.342 7.56384 460.649 16.6197 453.701 30.9185C445.561 47.5023 439.54 71.4218 437.076 98.4605C430.873 166.307 444.768 191.354 474.274 191.354C503.732 191.354 519.735 165.675 529.329 138.408C538.813 111.453 550.476 94.8278 574.793 94.8278C594.892 94.8278 610.773 109.716 610.773 137.756C610.773 168.773 590.649 192.098 565.22 192.346C542.841 192.594 528.143 174.48 529.632 147.185C531.369 116.912 549.731 94.8278 573.801 94.8278C587.696 94.8278 599.368 101.005 608.54 107.731C633.407 125.872 652.567 114.661 659.905 96.7242"
            stroke="white"
            strokeWidth="14.8883"
            strokeLinecap="round"
          />
