  ...
  return (
    <div className="w-full h-screen bg-black flex justify-center items-center overflow-hidden m-0 p-0">
      ...
      <div className="w-[92%] sm:w-[84%] max-w-275 flex flex-col justify-center items-center gap-2 sm:gap-3 px-2 sm:px-0 -translate-y-6 sm:-translate-y-8">
        ...
        >
          <path
            d="M7.44531 166.558C34.9925 151.245 60.0941 131.553 88.5723 98.0349C107.957 75.1542 118.378 49.0282 118.875 31.008C119.123 17.609 112.589 7.4442 100.512 7.4442C87.113 7.4442 78.6763 17.609 73.4653 40.9417C67.7581 66.5846 63.5398 96.009 52.8698 190.361"
            stroke="white"
            strokeWidth="14.8883"
            strokeLinecap="round"
          />
          <path
            d="M53.9155 181.14C59.3782 133.12 80.165 98.0534 106.716 98.0534C122.597 98.0534 132.69 110.708 129.824 128.823C128.211 139.493 126.341 150.411 124.162 163.066C121.622 178.947 128.881 191.354 150.875 191.354C182.95 191.354 217.943 173.529 235.85 145.921C241.952 136.515 244.433 128.078 244.681 119.89C244.929 105.001 236.493 93.835 221.604 93.835C202.746 93.835 188.354 115.175 188.354 142.47C188.354 171.751 204.235 192.346 235.692 192.346C273.974 192.346 305.652 161.766 313.684 118.542C315.055 111.162 316.993 103.364 317.882 95.8201"
            stroke="white"
            strokeWidth="14.8883"
            strokeLinecap="round"
          />
          <path
            d="M317.882 95.8203C313.25 135.109 308.618 174.398 303.986 213.686C299.392 252.658 287.857 268.277 270.487 268.277C258.825 268.277 250.388 260.85 250.388 248.922C250.388 232.985 262.483 221.543 290.339 212.942C341.145 197.254 362.537 179.263 375.698 145.2"
            stroke="white"
            strokeWidth="14.8883"
            strokeLinecap="round"
          />
